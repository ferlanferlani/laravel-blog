    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto {{ ($title === "Blog") ? 'active' : '' }}" href="/blog/">Blog</a></li>
          <li><a class="nav-link scrollto {{ ($title === "Categories") ? 'active' : '' }}" href="/categories/">Categories</a></li>
